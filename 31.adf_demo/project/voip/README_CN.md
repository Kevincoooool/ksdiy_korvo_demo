...
```
  python $IDF_PATH/components/esptool_py/esptool/esptool.py --chip esp32s3 --port COM14 --baud 921600 --before default_reset --after hard_reset write_flash -z --flash_mode dio --flash_freq 40m --flash_size detect 0x210000 ./tools/audio-esp.bin
## 如何使用例程
