...
static const board_res_desc_t g_board_s3_box_res = {
    ...
    .BSP_BUTTON_EN =   (1),
    .BUTTON_ADC_CHAN =  ADC1_CHANNEL_5,
    .BUTTON_TAB =  g_btns,
    ...
    .FUNC_SDMMC_EN =   (1),
    .SDMMC_BUS_WIDTH = (4),
    .GPIO_SDMMC_CLK =  (GPIO_NUM_15),
    .GPIO_SDMMC_CMD =  (GPIO_NUM_7),
    .GPIO_SDMMC_D0 =   (GPIO_NUM_4),
    ...
    .FUNC_PWR_CTRL =       (1),
    .GPIO_PWR_CTRL =       (GPIO_NUM_48),
    .GPIO_PWR_ON_LEVEL =   (1),

    .GPIO_MUTE_NUM =   GPIO_NUM_41,
    .GPIO_MUTE_LEVEL = 1,
